...
export function PuzzleBoard({ board, imageSrc, onTileMove }: PuzzleBoardProps): React.ReactElement {
  ...
  return (
    <div className="mx-auto rounded-3xl border border-slate-800 bg-slate-900/80 p-4 shadow-2xl shadow-black/30" style={{ width: `min(100%, calc((100dvh - 11rem) * ${board.cols} / ${board.rows}))` }}>
      <div
